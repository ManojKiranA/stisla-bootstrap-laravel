<aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="{{route('pages.generaldashboard')}}">Stisla</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="{{route('pages.generaldashboard')}}">St</a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Dashboard</li>
            <li class="dropdown {{Aktiv::areRoutesActive(['pages.generaldashboard','pages.ecommercedashboard','landing.dashboardpage'])}}">
              <a href="#" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Dashboard</span></a>
              <ul class="dropdown-menu">
                <li class="{{Aktiv::areRoutesActive(['pages.generaldashboard','landing.dashboardpage'])}}"><a class="nav-link" href="{{route('pages.generaldashboard')}}">General Dashboard</a></li>
                <li class="{{Aktiv::isRouteActive('pages.ecommercedashboard')}}"><a class="nav-link" href="{{route('pages.ecommercedashboard')}}">Ecommerce Dashboard</a></li>
              </ul>
            </li>
            <li class="menu-header">Starter</li>
            <li class="dropdown {{Aktiv::areRoutesActive(['layouts.defaultlayout'])}}">
              <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Layout</span></a>
              <ul class="dropdown-menu">
                <li class="{{Aktiv::isRouteActive('layouts.defaultlayout')}}"><a class="nav-link" href="{{route('layouts.defaultlayout')}}">Default Layout</a></li>
